...
export function usePermissions() {
  ...
  return {
    ...
    canReadProxyGroups: hasPermission('proxygroups:read'),
    canCreateProxyGroups: hasPermission('proxygroups:create'),
    canUpdateProxyGroups: hasPermission('proxygroups:update'),
    canDeleteProxyGroups: hasPermission('proxygroups:delete'),
