...
export function mapProxyToReverseDefaults(data: ProxyConfig): ReverseProxyFormValues {
  ...
  return {
    ...
    ssl_enabled: data.ssl_enabled ?? null,
    ssl_forced: data.ssl_forced ?? null,
    block_exploits: data.block_exploits ?? null,
    tls_insecure_skip_verify: data.tls_insecure_skip_verify ?? null,
